    ...
    <>
        ...
        {agents && ( 
          <main className="relative flex min-h-screen flex-col bg-[#0A141E] items-center justify-center">
                ...
                <Image  priority={true} fill  src={`/assets/images/agent_select.jpg`}  className="object-cover overflow-hidden w-full h-full" alt="agent select" />

                <div className="relative w-full h-full md:grid md:grid-cols-5 md:gap-2 mt-auto  bg-[#0A141E] ">
